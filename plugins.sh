...
projects=("skinsrestorer" "simple-voice-chat" "worldedit" "chunky" "pl3xmap" "luckperms" "packstacker" "knockbacksync" "packetevents" "geyser-recipe-fix" "geyserextras" "interactionvisualizer" "holomobhealth")
