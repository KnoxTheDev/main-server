...
projects=("simple-voice-chat" "worldedit" "pl3xmap" "chunky" "bluemap" "luckperms" "packstacker" "knockbacksync" "packetevents" "geyser-recipe-fix" "geyserextras" "interactionvisualizer" "holomobhealth")
